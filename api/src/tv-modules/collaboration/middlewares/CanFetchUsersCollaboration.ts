...
export const CanFetchUsersCollaboration = async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (!permissions) {
        $logger.error('Can not get permissions for CanFetchUsersCollaboration middleware');
